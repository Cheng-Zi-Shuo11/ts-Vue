...
export default class EchartsTable extends Vue {
        ...
        axisLabel: {
          formatter: function(value: any, index: any) {
            ...
            return (
              ...
              "}\n{table|" +
              data.attainment_rate[indexNum] +
              "%}\n{table|" +
              data.productivity[indexNum] +
              "%}"
            );
          },
          rich: {
  ...
  private initEcharts() {
    this.echarts = this.$echarts.init(this.$refs.table) as HTMLDivElement;
  }
