...
@Component({
  name: "SignIn",
  components: {
    Verification: () => import("../Verification/index.vue"),
    PopoverVerification: () => import("../Verification/Popover.vue"),
  },
})
        ...
        if (valid) {
          ...
          axios.post("/api/login").then((res) => {
            if (
              ...
              window.sessionStorage.setItem("tokenId", res.data.tokenStr);
