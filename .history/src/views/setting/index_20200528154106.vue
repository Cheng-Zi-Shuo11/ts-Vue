      ...
      >
        ...
        <el-form-item label="地址" prop="address">
          <template>
            ...
            >
              <el-option
                v-for="(item, index) in ruleForm.address.province"
                :key="index"
                :value="item.name"
                :label="item.name"
              >
            ...
            >
              <el-option
                v-for="item in ruleForm.address"
                :label="item.label"
                :value="item.value"
                :key="item.value"
              >
...
import elementUI from "../uiLibrary/edit/elementUI.vue";
...
export default class ClassName extends Vue {
  ...
  private getProvince() {
    ...
    (this.ruleForm.address.province as any) = arr;
  }
  ...
  private changeProvince(val: any) {
    console.log(val);
    ChianProvinceModule.province.forEach((item: any[]) => {
      if (val === item.name) {
        this.ruleForm.address.city.push(item.city);
      }
    });
  }
  ...
  private submitForm(formName: any) {
    (this.$refs[formName] as elementUI).validate((valid: boolean) => {
      console.log(valid);
      if (valid) {
